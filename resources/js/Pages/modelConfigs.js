export const modelConfigs = {
  ...
  Party: {
    ...
    fields: [
      ...
      { name: 'party_type', label: 'Type', type: 'select', options: [
        { value: 'supplier', label: 'Supplier' }, { value: 'customer', label: 'Customer' }, { value: 'both', label: 'Supplier & Customer' },
      ] },
  ...
  Product: {
    ...
    fields: [
      ...
      { name: 'quantity', label: 'Opening Quantity', type: 'number' },
  ...
  PurchaseBatch: {
    ...
    fields: [
      ...
      { name: 'party', label: 'Party', type: 'select', optionsKey: 'parties' },
      { name: 'currency', label: 'Currency', type: 'select', optionsKey: 'currencies' },
  ...
  PurchaseItem: {
    ...
    fields: [
      { name: 'purchase', label: 'Purchase Batch', type: 'select', optionsKey: 'purchaseBatches' },
      { name: 'product', label: 'Product', type: 'select', optionsKey: 'products' },
      { name: 'quantity', label: 'Quantity', type: 'number', required: true },
      { name: 'piece_or_pack', label: 'Piece or Pack', type: 'select', options: [{ value: 'piece', label: 'Piece' }, { value: 'pack', label: 'Pack' }] },
      { name: 'unit_for_piece', label: 'Unit for Piece', type: 'select', optionsKey: 'units' },
      { name: 'unit_for_pack', label: 'Unit for Pack', type: 'select', optionsKey: 'units' },
      { name: 'per_pack', label: 'Per Pack', type: 'number' },
  ...
  PurchasePayment: {
    ...
    fields: [
      { name: 'purchase', label: 'Purchase Batch', type: 'select', optionsKey: 'purchaseBatches' },
      { name: 'account', label: 'Account', type: 'select', optionsKey: 'accounts' },
      { name: 'transaction', label: 'Transaction', type: 'select', optionsKey: 'transactions' },
      { name: 'currency', label: 'Currency', type: 'select', optionsKey: 'currencies' },
    ],
  },
  Sale: {
  ...
  SaleItem: {
    ...
    fields: [
      { name: 'sale', label: 'Sale', type: 'select', optionsKey: 'sales' },
      { name: 'purchase_item', label: 'Purchase Item', type: 'select', optionsKey: 'purchaseItems' },
      { name: 'quantity', label: 'Quantity', type: 'number', required: true },
      { name: 'pack_or_piece', label: 'Pack or Piece', type: 'select', options: [{ value: 'piece', label: 'Piece' }, { value: 'pack', label: 'Pack' }] },
      { name: 'note', label: 'Note', type: 'textarea' },
    ],
  },
  SalePayment: {
  ...
  StockProfitReport: {
    ...
    fields: [
      { name: 'report_scope', label: 'Scope', type: 'select', options: [{ value: 'general', label: 'General' }, { value: 'batch', label: 'Purchase Batch' }, { value: 'product', label: 'Product' }] },
      { name: 'purchase_batch', label: 'Purchase Batch', type: 'select', optionsKey: 'purchaseBatches' },
      { name: 'product', label: 'Product', type: 'select', optionsKey: 'products' },
      { name: 'currency', label: 'Currency', type: 'select', optionsKey: 'currencies' },
